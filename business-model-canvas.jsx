...
${summary}`;
  ...
  const runAI = async (overrideTarget = null, overrideMode = null) => {
    ...
    try {
      ...
      const response = await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-pro-exp-0205:generateContent?key=" + apiKey, {
        method: "POST",
...
const TEMPLATES = {
  ...
  saas: {
    ...
    data: {
      key_partners: [
        { id: 1, text: "Provedores de Nuvem (AWS/Azure)" },
        { id: 2, text: "Parceiros de Integração (Slack/Jira)" },
        { id: 3, text: "Agências especializadas em Marketing B2B" },
      ],
      key_activities: [
        { id: 4, text: "Desenvolvimento Ágil e contínuo do software" },
        { id: 5, text: "Gestão do Customer Success e Retenção" },
        { id: 6, text: "Aquisição de clientes via Inbound Marketing" },
      ],
      key_resources: [
        { id: 7, text: "Equipe de Engenheiros e UX/UI de topo" },
        { id: 8, text: "Servidores escaláveis de alta disponibilidade" },
        { id: 9, text: "Algoritmos proprietários de Machine Learning" },
      ],
      value_propositions: [
        { id: 10, text: "Redução de 30% no tempo de criação de relatórios" },
        { id: 11, text: "Centralização da comunicação da equipe em tempo real" },
        { id: 12, text: "Previsibilidade de entrega de projetos com IA avançada" },
      ],
      customer_relationships: [
        { id: 13, text: "Suporte técnico 24/7 (CSM dedicado para planos Enterprise)" },
        { id: 14, text: "Processo de Onboarding automatizado para novos usuários" },
        { id: 15, text: "Comunidade VIP e base de conhecimento robusta" },
      ],
      channels: [
        { id: 16, text: "Equipe de Vendas Inbound" },
        { id: 17, text: "Marketing de Conteúdo (SEO e Blog técnico)" },
        { id: 18, text: "Ads segmentados no LinkedIn e Google" },
      ],
      customer_segments: [
        { id: 19, text: "Médias Empresas (PMEs) em crescimento" },
        { id: 20, text: "Equipes de engenharia de software e agilidade" },
        { id: 21, text: "Gerentes de projeto e produtos focados no B2B" },
      ],
      cost_structure: [
        { id: 22, text: "Altos salários e encargos da equipa de desenvolvimento e engenharia" },
        { id: 23, text: "Custos mensais contínuos com hospedagem Cloud e APIs externas" },
        { id: 24, text: "Investimento massivo em CAC (Marketing Técnico e Vendas)" },
      ],
      revenue_streams: [
        { id: 25, text: "Assinatura Mensal Recorrente (MRR por Utilizador)" },
        { id: 26, text: "Taxa adicional de upgrade para assentos vitais" },
        { id: 27, text: "Pacotes adicionais de Consultoria e Implementação Premium" },
      ],
    },
  },
  ecommerce: {
