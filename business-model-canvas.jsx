...
const TEMPLATES = {
  ...
  saas: {
    ...
    data: {
      key_partners: [
        { id: 1, text: "Fornecedores de pó de metal e polímeros avançados" },
        { id: 2, text: "Centros de pesquisa e universidades (P&D colaborativo)" },
        { id: 3, text: "Distribuidores e integradores de tecnologia industrial" },
      ],
      key_activities: [
        { id: 4, text: "P&D de novos sistemas de extrusão e fusão" },
        { id: 5, text: "Calibração e controle de qualidade extremamente rigoroso" },
        { id: 6, text: "Montagem e manutenção preditiva de hardware" },
      ],
      key_resources: [
        { id: 7, text: "Patentes de tecnologia de impressão 3D industrial" },
        { id: 8, text: "Equipe de engenharia mecatrônica e ciência dos materiais" },
        { id: 9, text: "Instalações de montagem e calibração de precisão" },
      ],
      value_propositions: [
        { id: 10, text: "Redução de desperdício na produção de peças complexas" },
        { id: 11, text: "Velocidade na prototipagem e fabricações flexíveis de lotes" },
        { id: 12, text: "Equipamentos robustos para uso contínuo no chão de fábrica" },
      ],
      customer_relationships: [
        { id: 13, text: "Contratos de Monitoramento contínuo (SLA rápida)" },
        { id: 14, text: "Treinamento presencial intensivo para operadores" },
        { id: 15, text: "Co-desenvolvimento de aplicações de impressão" },
      ],
      channels: [
        { id: 16, text: "Vendas diretas B2B (Key Account Executives)" },
        { id: 17, text: "Feiras internacionais de tecnologia industrial (Formnext)" },
        { id: 18, text: "Parceiros integradores especializados em maquinários" },
      ],
      customer_segments: [
        { id: 19, text: "Indústrias aeroespacial, automotiva e da saúde (próteses)" },
        { id: 20, text: "Birôs de fabricação e modelagem de moldes (tooling)" },
        { id: 21, text: "Centros de pesquisa avançada em novos materiais" },
      ],
      cost_structure: [
        { id: 22, text: "Custos massivos com prototipagem e P&D" },
        { id: 23, text: "Aquisição de peças CNC de alta precisão" },
        { id: 24, text: "Formação de uma equipa de suporte técnico B2B" },
      ],
      revenue_streams: [
        { id: 25, text: "Venda direta de máquinas industriais de grande formato" },
        { id: 26, text: "Contratos anuais rentáveis de manutenção e software" },
        { id: 27, text: "Venda de pós metálicos e ligas resinosas homologadas" },
      ],
    },
  },
  ecommerce: {
